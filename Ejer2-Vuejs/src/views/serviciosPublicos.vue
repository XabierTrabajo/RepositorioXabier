   ...
   <table>
    ...
    <tr v-for="servicio in serviciosFiltrados"  v-show="servicio.MOSTRAR==1">
        ...
        <td>
            ...
            <img v-if="clicked==false" src="../../src/assets/corazon-vacio.png" width="20" height="20" alt="">
            <img v-else src="../../src/assets/corazon-lleno.png" width="20" height="20" alt="">
          </a>
        </td>
...
export default{
    ...
    methods: {
        marcarfavorito(servicio){
            this.clicked=true;
            this.favoritos.findIndex(ser => ser == servicio);
